...
/// Thin wrapper around the browser [BroadcastChannel] API (web only).
///
/// A BroadcastChannel is shared by every same-origin tab and does not echo
/// messages back to the sender, which makes it a neat, dependency-free way to
/// let a "leader" tab drive one or more "member" tabs — handy for trying the
/// live flow on a static host such as GitHub Pages.
class BroadcastBus {
